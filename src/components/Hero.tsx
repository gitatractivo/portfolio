...
const Hero = ({ isLoading, isLoaded, setIsLoaded }: Props) => {
  ...
  return (
    <section data-scroll data-scroll-section data-scroll-speed="-.3"  >
      {/* @ts-ignore */}
      <div ref={parentRef} className="clipPath bg-clip-border translate-y-full  px-5 pb-[10vh]  w-screen  z-10 overflow-hidden flex flex-col justify-between py-0 bg-gray-300 max-h-[105dvh]    box-border h-[110vh]">

      <div className="flex flex-col gap-10 mt-3">

        <div className='flex flex-col my-36  iam justify-start gap-0 text-2xl md:text-4xl lg:text-7xl mx-[4vw]  tracking-tighter   !leading-tight font-bold  line-clamp-1'>
          <h1>I am a </h1>

...
const Hero = ({ isLoading }: Props) => {
  ...
  console.log(parent)
  return (
    <div ref={parentRef} className='scale-[0.4]  px-5 -rotate-[10deg] translate-y-[30vh]  translate-x-[5vw] w-screen z-10 flex flex-col justify-between py-0 bg-white max-h-[100dvh]  box-border h-screen'>
      <div className="flex flex-col gap-10 mt-3">
        <nav className='w-1/2 nav bg-[#B1DD41] rounded-lg backdrop-blur-lg p-8  mx-auto'></nav>

        <div className='flex flex-col px-2 md:px-5 iam justify-start gap-0 text-2xl md:text-4xl lg:text-7xl mx-[4vw]  !leading-tight font-medium line-clamp-1'>
          <h1>I am a </h1>

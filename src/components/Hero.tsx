...
const Hero = ({ isLoading }: Props) => {
  ...
  console.log(parent)
  return (
    <div ref={parentRef} className='clipPath bg-clip-border translate-y-full  px-5   translate-x-[5vw] w-screen z-10 flex flex-col justify-between py-0 bg-gray-300 max-h-[100dvh]   box-border h-screen'>
      <div className="flex flex-col gap-10 mt-3">
        <nav className='-translate-y-100 w-1/2 nav bg-[#B1DD41] rounded-lg backdrop-blur-sm filter p-8  mx-auto'></nav>

        <div className='flex flex-col mt-4  iam justify-start gap-0 text-2xl md:text-4xl lg:text-7xl mx-[4vw] tracking-tighter   !leading-tight font-bold  line-clamp-1'>
          <h1>I am a </h1>

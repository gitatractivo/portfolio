...
const NavButton = ({ text, onClick }: NavButtonProps) => {
  ...
  return (
    ...
    < button ref={ref} onClick={onClick} className="navbtn uppercase bg-transparent font-bold text-black relative tracking-widest px-6 py-3 rounded-full border-2 hover:text-white z-10  border-black"  >
